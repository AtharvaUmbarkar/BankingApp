...
public class TestAdminController 
{
	...
	public void testAdminLogin() throws Exception
	{
		...
		adminDTO.setLoginPassword("admin@1234");
	...
	public void testAllCustomers() throws Exception
	{
		...
		MvcResult mvcRes = mvc.perform(get("/fetch/AllCustomers").
				contentType(MediaType.APPLICATION_JSON).characterEncoding("utf-8").
	...
	public void testToggleUser() throws Exception
	{
		...
		Mockito.when(customerService.toggleUser(cust.getUserName())).thenReturn(true);
		boolean toggleOutput = customerService.toggleUser(cust.getUserName());
		assertEquals(toggleOutput,true);
